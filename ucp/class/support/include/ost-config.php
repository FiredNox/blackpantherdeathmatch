...
define('SECRET_SALT','wk2A-GFPC4SAV.GIvfZQN-qqYs2C4u9d');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','marcell@cs2dservices.com');
...
define('DBNAME','c0cs2dsupport');
define('DBUSER','c0cs2duser');
define('DBPASS','lcciRN#J8');
