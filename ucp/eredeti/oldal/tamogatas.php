<?php
	echo'<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td style="padding-right: 5px;" align="center"><div class="subnav_gomb" style="font-weight: bold;" onclick="window.location.href=\'index.php?menu=tamogatas&hunsms\';">SMS <font style="font-weight: normal; font-style: italic">(MAGYAR)</font></div></td>
				<td style="padding-right: 5px;" align="center"><div class="subnav_gomb" style="font-weight: bold;" onclick="window.location.href=\'index.php?menu=tamogatas&kulfsms\';">SMS <font style="font-weight: normal; font-style: italic">(KÜLFÖLDI)</font></div></td>
				<td style="padding-right: 5px;" align="center"><div class="subnav_gomb" style="font-weight: bold;" onclick="window.location.href=\'index.php?menu=tamogatas&utalas\';">BANKI UTALÁS</div></td>
			</tr>
		</table>';
	...
	if(isset($_GET['kulfsms'])) {
		echo'<h1><font color="green"> KÜLFÖLDI</font> SMS TÁMOGATÁS CSOMAGOK</h1>
			<table border="0" style="padding-top: 20px;" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td style="padding-right: 5px;" align="center"><div class="subnav_gomb" style="font-weight: bold;" onclick="window.location.href=\'index.php?menu=tamogatas&ukrajna\';">Ukrajna (16 UAH ÁFÁ-val)</div></td>
